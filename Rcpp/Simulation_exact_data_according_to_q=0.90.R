...
# according to q = 0.90 based on Method 2.
q1 <- 0.95
...
## Method 2: q2 = 0.90
#------------------------------------------------------------------------------------
pdf('Simulation_AfterBurnin=30k_Burnin=10k_a=5000_b=1_TrueMethod_q=0.90.pdf', 
